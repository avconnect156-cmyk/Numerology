      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 lg:mb-16">
          ...
          <h2 className="mt-6 text-3xl sm:text-4xl md:text-[2.5rem] lg:text-[3rem] xl:text-[3.5rem] font-serif font-bold leading-[1.1] text-white">
            ...
            <span className="block mt-2 bg-gradient-to-r from-[#FFE27A] via-[#FFD54F] to-[#F4B400] bg-clip-text text-transparent">
              Of The Vedas
            </span>
          ...
          <p className="mt-6 max-w-3xl mx-auto text-sm sm:text-base md:text-[15px] lg:text-[16px] leading-7 text-white/75">
            ...
            —not created by humans but divinely revealed and eternal.

            Their knowledge is believed to have originated directly from the
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-10">
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-[#FFD54F]/20 bg-white/5 backdrop-blur-xl p-6 sm:p-8 lg:p-10 transition-all duration-500 hover:-translate-y-2 hover:border-[#FFD54F]/50 hover:shadow-[0_20px_60px_rgba(255,213,79,0.18)]">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm sm:text-base md:text-[15px] lg:text-[16px] leading-7 text-white/80">
                ...
                and passed it on for the welfare of humanity.

                <br />
                <br />

                Some traditions state that the
                <strong>
                  {" "}four Vedas
                </strong>{" "}
                emerged from his
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-[#FFD54F]/20 bg-white/5 backdrop-blur-xl p-6 sm:p-8 lg:p-10 transition-all duration-500 hover:-translate-y-2 hover:border-[#FFD54F]/50 hover:shadow-[0_20px_60px_rgba(255,213,79,0.18)]">
            ...
            <div className="absolute -bottom-20 -left-20 w-44 h-44 sm:w-52 sm:h-52 lg:w-60 lg:h-60 rounded-full bg-[#FFD54F]/10 blur-[100px]" />
