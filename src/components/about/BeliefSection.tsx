  ...
  return (
    <section className="relative overflow-hidden pt-8 sm:pt-10 lg:pt-12 pb-16 sm:pb-20 lg:pb-24">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="group relative overflow-hidden rounded-3xl border border-[#FFD54F]/20 bg-white/5 backdrop-blur-xl p-6 sm:p-8 lg:p-10 transition-all duration-500 hover:border-[#FFD54F]/50 hover:shadow-[0_20px_60px_rgba(255,213,79,0.18)]">
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-[#FFD54F] to-[#F4B400] flex items-center justify-center text-2xl sm:text-3xl shadow-lg flex-shrink-0">
        ...
        <div className="group relative overflow-hidden rounded-3xl border border-[#FFD54F]/20 bg-white/5 backdrop-blur-xl p-6 sm:p-8 lg:p-10 mt-8 transition-all duration-500 hover:border-[#FFD54F]/50 hover:shadow-[0_20px_60px_rgba(255,213,79,0.18)]">


          <div className="absolute -bottom-20 -left-20 w-44 h-44 sm:w-56 sm:h-56 lg:w-72 lg:h-72 rounded-full bg-[#FFD54F]/10 blur-[100px]" />
        ...
        <div className="grid lg:grid-cols-2 gap-8 mt-8">
          ...
          <div className="rounded-3xl border border-[#FFD54F]/20 bg-white/5 backdrop-blur-xl p-6 sm:p-8">
            ...
            <h3 className="text-2xl sm:text-[24px] md:text-[26px] font-bold text-[#FFD54F] mb-6">
            ...
            <ul className="space-y-4 text-sm sm:text-base md:text-[15px] lg:text-[16px] leading-7 text-white/85">
          ...
          <div className="rounded-3xl border border-[#FFD54F]/20 bg-white/5 backdrop-blur-xl p-6 sm:p-8">
            ...
            <ul className="space-y-4 text-sm sm:text-base md:text-[15px] lg:text-[16px] leading-7 text-white/85">
              ...
              <li>
                • Simultaneously, we create new karma through our present actions
              </li>
        ...
        <div className="rounded-3xl border border-[#FFD54F]/20 bg-white/5 backdrop-blur-xl p-6 sm:p-8 lg:p-10 mt-8">


          <h3 className="text-2xl sm:text-[24px] md:text-[26px] lg:text-[28px] font-bold text-[#FFD54F] mb-6">
          ...
          <div className="mt-6 rounded-2xl border border-[#FFD54F]/10 bg-white/5 p-5 sm:p-6">
          ...
          <div className="mt-8 h-[3px] w-0 rounded-full bg-gradient-to-r from-[#FFD54F] to-[#F4B400] transition-all duration-500 hover:w-28"></div>
