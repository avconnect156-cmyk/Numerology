...
const PhilosophySection = () => {
  return (
    <section className="relative overflow-hidden pt-16 sm:pt-20 lg:pt-24 pb-8 sm:pb-10 lg:pb-12 bg-[linear-gradient(180deg,#020617_0%,#0F172A_45%,#134E4A_80%,#14532D_100%)]">
