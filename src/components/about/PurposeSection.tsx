    ...
    <section className="relative overflow-hidden pt-36 pb-16 sm:pt-40 sm:pb-20 lg:pt-44 lg:pb-24 xl:pt-48 xl:pb-28 bg-[linear-gradient(180deg,#020617_0%,#0F172A_45%,#134E4A_80%,#14532D_100%)]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 lg:mb-16">
          <span className="inline-block px-4 py-2 md:px-5 md:py-2 rounded-full border border-[#FFD54F]/30 bg-[#FFD54F]/10 text-[#FFD54F] uppercase tracking-[2px] md:tracking-[2.5px] text-xs md:text-sm font-semibold">
          ...
          <p className="mt-6 max-w-3xl mx-auto text-sm sm:text-base md:text-[15px] lg:text-[16px] leading-7 text-white/75">
            ...
            to create a life filled with clarity, harmony, success, and
            purpose.
          </p>
